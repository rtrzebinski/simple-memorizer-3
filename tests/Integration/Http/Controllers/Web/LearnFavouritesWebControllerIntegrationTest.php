...
class LearnFavouritesWebControllerIntegrationTest extends WebTestCase
{
    // learnFavourites
    ...
    public function itShould_showLearnFavouritesPage()
    {
        ...
        $this->assertEquals(
            'http://localhost/exercises/' . $userExercise->exercise_id . '/edit?hide_lesson=true&redirect_to=%2Flearn%2Ffavourites%2F%3Frequested_exercise_id%3D' . $userExercise->exercise_id,
            $editExerciseUrl
        );
