                ...
                @else
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            Nice one! Looks like you've learnt all you needed for this lesson! </br>
                            <a href="/lessons/{{ $lesson->id }}/settings" class="text-info">Change lesson threshold</a> to continue learning.
                        </div>
                    </div>
